class PeriodicTableTool {
  ...
  startQuizMode() {
    ...
    quizBtn.textContent = 'Quiz beenden';
    quizBtn.classList.replace('primary', 'secondary');
  ...
  showInfoMode() {
    ...
    const quizBtn = document.getElementById('quiz-btn');
    quizBtn.textContent = 'Quiz starten';
    quizBtn.classList.replace('secondary', 'primary');
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const app = new PeriodicTableTool();
  window.periodicTable = app;
});
